package com.mouse.api.feign.admin;

import com.mouse.api.hystrix.admin.HystrixAdminResourcesFeign;
...
@FeignClient(name = "http://ROTOR-API",
        path = "rotor-api/admin/resources",
        fallbackFactory = HystrixAdminResourcesFeign.class)
public interface AdminResourcesFeign {
