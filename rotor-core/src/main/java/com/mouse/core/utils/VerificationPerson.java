...
/**
 * @author ; lidongdong
 * @Description 根据银行卡号获取银行名称、编码、类型
 * @Date 2020-01-08
 */
public class VerificationPerson {
    ...
    public static void main(String[] args) {
        VerificationPerson verificationPerson = new VerificationPerson("6217580100007232630");
        System.out.println(verificationPerson.getBankId());
        System.out.println(verificationPerson.getBankName());
        System.out.println(verificationPerson.getCardType());
    }
}
