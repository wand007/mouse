...
Page({
    ...
    getGoodsInfo: function () {
        ...
        util.request(api.GoodsDetail, {
            ...
            if (res.statusCode === 10000) {
                ...
                if (_specificationList != null && _specificationList.length == 1) {
    ...
    addCollectOrNot: function () {
        let that = this;
        util.baseSend(api.CollectAddOrDelete, {
            type: 0,
            ...
            util.request(api.CartFastAdd, {
                ...
                .then(function (res) {
                    if (res.statusCode === 10000) {
                        ...
                        util.showErrorToast(res.statusText);
                    }
                });
        }
            ...
            util.request(api.CartAdd, {
                ...
                .then(function (res) {
                    ...
                    if (_res.statusCode === 10000) {
                        ...
                        util.showErrorToast(_res.statusText);
                    }
