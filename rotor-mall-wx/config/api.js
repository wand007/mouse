// 以下是业务服务器API地址
// 本机开发时使用
var WxApiRoot = 'http://localhost:30032/mall/';
// 局域网测试使用
...
module.exports = {
  ...
  GoodsList: WxApiRoot + 'goods/findPage', //获得商品列表
  ...
  TopicList: WxApiRoot + 'topic/findPage', //专题列表
  ...
  AddressList: WxApiRoot + 'address/findPage', //收货地址列表
  ...
  RegionList: WxApiRoot + 'region/findPage', //获取区域列表

  OrderSubmit: WxApiRoot + 'order/submit', // 提交订单
  OrderPrepay: WxApiRoot + 'order/prepay', // 订单的预支付会话
  OrderList: WxApiRoot + 'order/findPage', //订单列表
  ...
  AftersaleList: WxApiRoot + 'aftersale/findPage', // 售后列表
  AftersaleDetail: WxApiRoot + 'aftersale/detail', // 售后详情

  FeedbackAdd: WxApiRoot + 'feedback/submit', //添加反馈
  FootprintList: WxApiRoot + 'footprint/findPage', //足迹列表
  FootprintDelete: WxApiRoot + 'footprint/delete', //删除足迹

  GroupOnList: WxApiRoot + 'groupon/findPage', //团购列表
  GroupOnMy: WxApiRoot + 'groupon/my', //团购API-我的团购
  GroupOnDetail: WxApiRoot + 'groupon/detail', //团购API-详情
  GroupOnJoin: WxApiRoot + 'groupon/join', //团购API-详情

  CouponList: WxApiRoot + 'coupon/findPage', //优惠券列表
  CouponMyList: WxApiRoot + 'coupon/personal/findPage', //我的优惠券列表
  ...
  IssueList: WxApiRoot + 'issue/findPage', //帮助信息
};