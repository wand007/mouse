...
--
-- Table structure for table `tbl_goods_attribute`
--
...
--
-- Table structure for table `tbl_goods_product`
--
...
--
-- Table structure for table `tbl_goods_specification`
--
...
--
-- Table structure for table `tbl_groupon`
--
...
CREATE TABLE `tbl_groupon` (
  ...
  `rules_id` int(11) NOT NULL COMMENT '团购规则ID，关联tbl_groupon_rules表ID字段',
  `user_id` int(11) NOT NULL COMMENT '用户ID',
...
--
-- Table structure for table `tbl_groupon_rules`
--
...
--
-- Table structure for table `tbl_user_formid`
--
