...
public class BrandEntity implements Serializable {
    ...
    private static final long serialVersionUID = -3224214140214461116L;
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Integer id;
    @Column(name = "name", columnDefinition = "varchar(60) COMMENT '品牌名称'", nullable = false)
    private String name;
    @Column(name = "user_id", columnDefinition = "varchar(32) COMMENT '管理员Id'", nullable = false)
    ...
    @Column(name = "new_sort_order", columnDefinition = "tinyint unsigned DEFAULT '50' COMMENT '新排序'", nullable = false)
