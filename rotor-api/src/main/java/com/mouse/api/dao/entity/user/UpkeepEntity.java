...
public class UpkeepEntity implements Serializable {
    ...
    private Integer id;
    @Column(name = "customer_id", columnDefinition = "int unsigned default '0' COMMENT '客户id'", nullable = false)
    ...
    @Column(name = "uid", columnDefinition = "int unsigned default '0' COMMENT '修改人id(维护人id)'", nullable = false)
    private String uid;
